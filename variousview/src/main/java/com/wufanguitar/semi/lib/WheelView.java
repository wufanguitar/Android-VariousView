...
import com.wufanguitar.semi.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        // 默认大小
        mTextSize = getResources().getDimensionPixelSize(R.dimen.dimen_20_sp);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (counter < mVisibleItems) {
            ...
            // 弧度转换成角度( 把半圆以 Y 轴为轴心向右转 90 度，使其处于第一象限及第四象限)
            // angle [-90°,90°]
    ...
    private String getContentText(Object item) {
        if (item == null) {
            ...
            return (String) ((IWheelViewData) item).getWheelViewData();
