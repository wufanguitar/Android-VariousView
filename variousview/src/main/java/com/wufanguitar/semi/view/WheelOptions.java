package com.wufanguitar.semi.view;

import android.graphics.Typeface;
import android.view.View;

import com.wufanguitar.semi.adapter.ArrayWheelAdapter;
import com.wufanguitar.variousview.R;
import com.wufanguitar.semi.adapter.ArrayWheelAdapter;
import com.wufanguitar.semi.lib.DividerType;
import com.wufanguitar.semi.lib.WheelView;
import com.wufanguitar.semi.listener.OnItemSelectedListener;
...
public class WheelOptions<T> {
    public View mView;
    public WheelView mOptionFirst;
    public WheelView mOptionSecond;
    public WheelView mOptionThird;

    public List<T> mOptionFirstItems;
    // 联动选项二的数据源
    public List<List<T>> mRelatedOptionSecondItems;
    // 非联动选项二的数据源
    public List<T> mOptionSecondItems;
    // 联动选项三的数据源
    public List<List<List<T>>> mRelatedOptionThirdItems;
    // 非联动选项三的数据源
    public List<T> mOptionThirdItems;
    // 是否联动
    public boolean mIsLinkage;
    public OnItemSelectedListener mOptionFirstListener;
    public OnItemSelectedListener mOptionSecondListener;

    // 外部文字的颜色
    public int mOutTextColor;
    // 选项中文字的颜色
    ...
    public void setRelatedOptions(List<T> optionFirstItems,
        ...
        // 设置选项一显示数据
        mOptionFirst.setAdapter(new ArrayWheelAdapter(mOptionFirstItems));
        // 初始化时显示的数据
    ...
    // 不联动情况下
    @SuppressWarnings("unchecked")
    public void setNoRelatedOptions(List<T> optionFirstItems,
