...
import com.wufanguitar.semi.adapter.NumericWheelAdapter;
import com.wufanguitar.semi.lib.DividerType;
import com.wufanguitar.semi.listener.OnItemSelectedListener;
import com.wufanguitar.semi.utils.ChinaDate;
import com.wufanguitar.semi.utils.LunarCalendar;
...
public class WheelTime {
    ...
    public void setDateTime(int year, final int month, int day, int hour, int minute, int second) {
        if (mIsLunarCalendar) {
    ...
    public void setTextXOffset(int xoffset_year, int xoffset_month, int xoffset_day, int xoffset_hours, int xoffset_mins, int xoffset_seconds) {
        mYearWheelView.setTextXOffset(xoffset_year);
        mMonthWheelView.setTextXOffset(xoffset_month);
        mDayWheelView.setTextXOffset(xoffset_day);
